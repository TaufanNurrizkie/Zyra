...
export default function AdminLayout({ children }) {
    ...
    return (
        <div className="bg-gray-50 min-h-screen overflow-x-hidden">
            ...
            <nav className="bg-gradient-to-r from-green-600 via-green-700 to-emerald-800 shadow-lg fixed top-0 inset-x-0 z-40">
                <div className="h-16 flex items-center justify-between px-6">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <div className="text-2xl font-bold text-white tracking-tight">Zyra</div>
                    </div>
                </div>
            </nav>
            ...
            {/* SIDEBAR + OVERLAY */}
            <div
                className={`fixed inset-0 z-50 transform transition-transform duration-300 ease-in-out ${open ? "translate-x-0" : "-translate-x-full"
                    }`}
                aria-hidden={!open}
            >
                {/* Overlay */}
                            ...
                            <div className="w-10 h-10 bg-amber-400 rounded-full flex items-center justify-center shadow-lg">
                                ...
                                >
                                    <path
                                        ...
                                        strokeLinejoin="round"
                                        strokeWidth={2}
                                        d="M12 8c-1.105 0-2 .895-2 2s.895 2 2 2 2-.895 2-2-.895-2-2-2zm0-6c1.38 0 2.63.56 3.54 1.46A5 5 0 0119 8a5 5 0 01-3.46 4.54c-.91.9-2.16 1.46-3.54 1.46s-2.63-.56-3.54-1.46A5 5 0 015 8a5 5 0 013.46-4.54C9.37 2.56 10.62 2 12 2z"
                                    />
                                </svg>
                            </div>
                            <div>
                    ...
                    <div className="p-4 border-t border-white/10 bg-white/5">
                        <div className="flex items-center gap-3 mb-4 p-3 rounded-lg hover:bg-white/10 transition-colors">
                            <a
                                href="/profile"
                                onClick={() => setOpen(false)}
                                className="flex items-center gap-3 w-full text-white no-underline"
                            >
                        ...
                        >
                            ...
                            >
                                <path
                                    ...
                                    strokeLinejoin="round"
                                    strokeWidth={2}
                                    d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1m0-9V4m-6 4V4m0 0H5a2 2 0 00-2 2v12a2 2 0 002 2h2"
                                />
                            </svg>
                            <span>Logout</span>
                        </a>
