            ...
            >
                ...
                <div className="relative p-4 border-t border-white/20 bg-white/5 backdrop-blur-sm">
                    ...
                    <button
                        ...
                        className={`group w-full bg-gradient-to-r from-red-500 via-red-600 to-red-700 hover:from-red-600 hover:via-red-700 hover:to-red-800 text-white font-semibold py-3.5 px-4 rounded-2xl flex items-center justify-center gap-3 transition-all duration-300 hover:shadow-xl hover:scale-105 active:scale-95 border border-red-400/30 ${open
                                ? "opacity-100 translate-x-0"
                                : "opacity-0 -translate-x-4"
                            }`}
