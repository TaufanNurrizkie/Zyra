...
export default function AdminIndex({ mustahik, relawanAktif, laporan, distribution, monthlyData, categoryData, weeklyData, totalPenerima, Program, persen }) {   // ✅ terima props dari Inertia
    ...
    return (
        <AdminLayout>
            ...
            >
                ...
                <DashboardCards mustahik={mustahik} relawanAktif={relawanAktif} laporan={laporan} Program={Program}/>
                <ChartSection distribution={distribution} monthlyData={monthlyData} categoryData={categoryData} weeklyData={weeklyData} totalPenerima={totalPenerima} relawanAktif={relawanAktif} persen={persen}/>
