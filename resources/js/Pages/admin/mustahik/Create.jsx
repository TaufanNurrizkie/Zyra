    ...
    const handleSubmit = (e) => {
        ...
        post("/mustahik", {
            onSuccess: () => {
                Swal.fire({
                    title: "Berhasil!",
                    text: "Data mustahik berhasil disimpan.",
                    icon: "success",
                    confirmButtonColor: "#2563eb", // biru sesuai Tailwind
                    confirmButtonText: "OK",
                }).then(() => {
                    Inertia.visit("/mustahik"); // pindah setelah klik OK
                });
            },
            onError: () => {
                Swal.fire({
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-gray-600 mt-2">
                                    Masukkan informasi lengkap untuk data
                                    mustahik baru
                                </p>
                            </div>
