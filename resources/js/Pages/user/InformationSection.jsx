      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12">
        ...
        <div ref={heroRef} className="text-center mb-20 pt-12">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button className="hero-button bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300">
              <Calculator className="w-5 h-5 mr-2" />
              Kalkulator Zakat
            </Button>
            <Button
              variant="outline"
              className="hero-button border-green-600 text-green-600 hover:bg-green-50 px-8 py-3 rounded-full bg-transparent"
            >
