  ...
  const jenisZakatOptions = [
    {
      ...
      detail:
        "Nisab zakat maal setara dengan 85 gram emas. Jumlah zakatnya 2,5% dari harta simpanan yang telah mencapai haul (1 tahun).",
    ...
    },
    {
      ...
      detail:
        "Nisab zakat penghasilan setara dengan 85 gram emas per tahun. Jumlah zakatnya 2,5% dari pendapatan bersih setiap bulan.",
    ...
    },
    {
      ...
      detail:
        "Besaran zakat fitrah adalah 2,5 kg beras/makanan pokok setempat, atau setara Rp40.000 - Rp50.000 per orang.",
    ...
    },
    {
      ...
      detail:
        "Zakat perdagangan wajib jika modal + keuntungan mencapai nisab (85 gram emas). Besarnya 2,5% dari nilai total harta usaha.",
      ...
      <div className="max-w-5xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-3xl font-bold text-gray-800">Pembayaran Zakat</h1>
          </div>
          <p className="text-gray-600 text-lg">
            Pilih jenis zakat dan tunaikan kewajiban Anda dengan mudah
          </p>
        ...
        {showCalculator && (
          ...
          >
            <CalculatorSection onCalculatorResult={handleCalculatorResult} />
          </motion.div>
        )}
            ...
            <form onSubmit={submit} className="p-8 space-y-8">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 mb-4">
                  {nominalSuggestions.map((suggestion) => (
                    <button
                      ...
                      type="button"
                      onClick={() => setData("total", suggestion.amount)}
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    value={data.total ? formatRupiah(data.total) : ""}
              ...
              <div>
                <button
                  type="submit"
                  disabled={!data.jenis || !data.total || processing}
                ...
                >
                  {processing ? "Memproses..." : "Bayar Zakat Sekarang"}
                </button>
              </div>
              ...
              <div className="border-t pt-6">
                ...
                <div className="flex justify-center gap-6 text-gray-600">
                  <div className="flex items-center gap-2 text-sm">
                    <CreditCard className="w-5 h-5 text-blue-500" /> Kartu Kredit
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <Building className="w-5 h-5 text-green-500" /> Transfer Bank
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <Wallet className="w-5 h-5 text-purple-500" /> E-Wallet
                  </div>
                </div>
              </div>
            </form>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Terima kasih telah menunaikan zakat. Semoga menjadi amal jariyah
                  yang berkah.
                </p>
                <button
        ...
        {showInfoModal && selectedInfo && (
          ...
          >
            ...
            >
              ...
              <p className="text-gray-700 mb-6">{selectedInfo.detail}</p>
